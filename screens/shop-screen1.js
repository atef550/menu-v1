...
const data2 = [
  { id: 1, count: 1, price: '10 EGP', header: 'Beverages', txt: "Coffee", disc: 'Coffe, Tea, Juice, etc...', img: require('../assets/Coffee.jpg'), isChecked: false },
  { id: 2, count: 1, txt: 'Coffee', header: 'Beverages', price: '12 EGP', disc: "            Sandwich, Burger, Pizza, etc...", img: require('../assets/Coffee2.jpg'), isChecked: false },
  { id: 3, count: 1, txt: 'Coffee', header: 'Beverages', price: '14 EGP', img: require('../assets/Coffee3.jpg'), isChecked: false },
];
